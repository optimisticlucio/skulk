...
A tabletop game originally made to practice coding skills (by making a digital version), now turned into a final project for uni.
...
2. Once the choices are made, each player gets their respective character's Starting Deck, and add their character's Influence Deck to the Main Deck.
3. Shuffle the Main Deck and both players' starting decks, and place the top 6 cards from the Main Deck in some place that's accessible and visible to both players; these cards are now the town. Both players draw 5 cards from their decks to their hands.
