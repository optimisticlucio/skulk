...
You are a monster. At least, a monster is what the people call you, in hushed tones and shakey whispers. Many years ago, you moved to the outskirts of Helena, Montana, believing this would be the best place to hide in from the angry mobs. A quiet life, a safe life. You were alone.
...
Each player chooses a side of the Suspicion Meter that will represent themselves (typically, the side of the meter which faces them). When the Suspicion Marker reaches the end of the meter on a player's chosen side, the player in question loses.

## Rules

During each player's turn, they may **play** cards from their hand, **buy** cards from the town to improve their deck, use their **ability**, or **end their turn**.

**Playing Cards** is simple: If you have a card in your hand, you place it infront of you (in your "**Play Area**"), and then follow whatever instructions are written on the card. Typically these instructions will let you draw more cards from your deck, earn **Fear** (the currency to purchase more cards), or inflict **Suspicion** (the metric which determines which head the town will mount on a pike).

You may **buy cards** from the Town (the six cards at the center of the table), if you've earned the amount of fear listed as the card's cost (on the topleft corner). If you did, place the given card in your **Discard Pile**, reduce the amount of fear in your possession appropriately, and replace the removed card with a new one from the top of the Main Deck.
